...
export default function CTASection() {
  return (
    <section className="py-24 bg-highlight-yellow border-t-3 border-b-3 border-black relative overflow-hidden">
      ...
      <div className="container-max mx-auto text-center relative z-10 px-4">
        ...
        <h2 className="font-heading text-5xl md:text-7xl font-black text-black mb-8 uppercase leading-[0.9] tracking-tighter">
