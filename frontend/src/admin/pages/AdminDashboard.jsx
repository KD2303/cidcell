...
import { Users, FileText, Folder, Shield, Calendar } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 border border-slate-200 rounded shadow-sm flex items-center gap-4">
          <div className="bg-purple-100 p-3 rounded text-purple-600"><Shield size={24} /></div>
          <div>
            <p className="text-sm font-semibold text-slate-500 uppercase">Team Members</p>
            <p className="text-2xl font-bold text-slate-900">{stats.members}</p>
          </div>
        </div>
        <div className="bg-white p-6 border border-slate-200 rounded shadow-sm flex items-center gap-4">
          <div className="bg-orange-100 p-3 rounded text-orange-600"><Calendar size={24} /></div>
          <div>
            <p className="text-sm font-semibold text-slate-500 uppercase">Live Events</p>
