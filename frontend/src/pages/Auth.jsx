...
const Auth = () => {
    ...
    return (
        <div className="min-h-screen bg-bg font-body flex items-center justify-center px-4 pt-28 md:pt-32 pb-10 overflow-hidden relative">

            {/* Decorative background blobs */}
            <div className="absolute top-24 right-8 w-20 h-20 bg-highlight-yellow border-3 border-primary rounded-full shadow-neo hidden sm:block animate-[float_4s_ease-in-out_infinite]" />
            <div className="absolute bottom-20 left-6 w-14 h-14 bg-highlight-purple border-3 border-primary shadow-neo hidden sm:block rotate-12" />
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-6">
                    <div className="inline-flex flex-col items-center gap-2 mb-2">
                        <img src="/logo.png" alt="CID-Cell Logo" className="w-16 h-16 shadow-neo transform -rotate-2" />
                ...
                {/* Main auth card */}
                <div className="bg-white border-4 border-primary shadow-neo rounded-xl relative overflow-hidden">
                    <div className="h-2 bg-highlight-yellow border-b-2 border-primary w-full" />

                    <div className="p-6 md:p-7 space-y-5">
                        <div className="space-y-2">
                            <div className="inline-block bg-highlight-purple border-2 border-primary px-3 py-1 shadow-neo-sm transform -skew-x-3">
                                <span className="font-heading uppercase text-xs tracking-widest">Member Portal</span>
                            </div>
                            <p className="font-heading text-2xl md:text-[28px] uppercase tracking-tight text-primary leading-none">
                                Sign In to<br />Your Account
                            </p>
                            <p className="font-body text-sm text-gray-500 normal-case font-medium leading-relaxed">
                        ...
                        <div className="flex flex-col items-center gap-3 bg-slate-50 border-2 border-primary/20 p-4 rounded-lg">
                            <GoogleLogin
                                ...
                                text="continue_with"
                            />
                            <p className="text-[11px] text-gray-500 font-body normal-case text-center">
                        ...
                        <div className="border-t-2 border-dashed border-primary/30 pt-4 flex items-center justify-between gap-3">
                            <p className="text-xs font-bold text-gray-500 uppercase tracking-wider font-body">New here?</p>
                ...
                <p className="text-center text-[10px] font-bold uppercase tracking-widest text-gray-500 mt-4">
