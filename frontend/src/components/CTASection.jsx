...
export default function CTASection() {
  ...
  return (
    <section ref={elementRef} className={`w-screen h-screen flex items-center py-14 bg-highlight-yellow border-t-3 border-b-3 border-black relative overflow-hidden transition-opacity duration-1000 ease-out ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className={`container-max mx-auto text-center relative z-10 px-4 transition-all duration-1000 delay-300 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}>
        ...
        <h2 className="font-heading text-3xl sm:text-4xl md:text-6xl font-black text-black mb-6 uppercase leading-[0.9] tracking-tighter">
        ...
        <div className="max-w-2xl mx-auto mb-8 relative">
          ...
          <p className="relative z-10 bg-white text-black font-medium text-base md:text-lg p-5 border-3 border-black leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link 
            to="/contact" 
            className="group relative px-7 py-3 bg-black text-white font-bold uppercase tracking-wider border-3 border-black shadow-neo hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px] transition-all flex items-center gap-2"
          >
            Get Started <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
          </Link>
          <Link 
            to="/projects" 
            className="group relative px-7 py-3 bg-white text-black font-bold uppercase tracking-wider border-3 border-black shadow-neo hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px] transition-all"
          >
            View Projects
          </Link>
        </div>
