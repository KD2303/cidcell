...
const ProfileCardComponent = ({
  ...
  return (
    ...
    >
      <div ref={shellRef} className="relative z-[1] group w-full h-full flex justify-center items-center">
        <section
        ...
        >
          ...
          >
            {/* Avatar content */}
            <div
              className="overflow-visible backface-hidden absolute inset-0"
              style={{
            ...
            >
              <img
                className="w-full h-full object-cover absolute left-0 top-0 backface-hidden will-change-transform transition-transform duration-[120ms] ease-out opacity-90"
                src={avatarUrl}
            ...
            {/* Details content */}
            <div
              className="max-h-full w-full overflow-hidden text-center justify-start flex flex-col relative z-[5]"
              style={{
                transform:
            ...
            >
              <h3
                className="font-black m-0 tracking-widest uppercase font-heading drop-shadow-[0_2px_4px_rgba(0,0,0,1)]"
                style={{
                  fontSize: 'min(1.25rem, 4svw)',
                  color: '#ffffff',
                  display: 'block',
                  borderRadius: '0',
                }}
              ...
              <p
                className="font-bold whitespace-nowrap mx-auto w-min tracking-widest uppercase drop-shadow-[0_2px_4px_rgba(0,0,0,1)] mt-1"
                style={{
                  fontSize: '9px',
                  color: '#cbd5e1',
                  display: 'block',
